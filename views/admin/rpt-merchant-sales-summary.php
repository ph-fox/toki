...
<div class="mt-3">
  ...
  <input type="submit" value="<?php echo t("Search")?>" class="btn btn-sm btn-success">
  <a href="javascript:;" rel="rptmerchantsalesummary" class="btn btn-sm btn-outline-primary"><?php echo t("Export")?></a>
</div>  
