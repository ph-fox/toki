...
<ul class="uk-switcher uk-margin email-settings" id="tab-content">
   ...
   echo "<span>".t("SMTP")."</span>";
    ...
    <div class="row">
	  <label class="form-label"><?php echo Yii::t("default","SMTP host")?></label>  
	  <?php 
    ...
    <div class="row">
	  <label class="form-label"><?php echo Yii::t("default","SMTP port")?></label>  
	  <?php 
	...
	<div class="row">
	  <label class="form-label"><?php echo Yii::t("default","Username")?></label>  
	  <?php 
	...
	<div class="row">
	  <label class="form-label"><?php echo Yii::t("default","SMTPSecure")?></label>  
	  <?php 
	...
	<p class="text-danger uk-text-small"><?php echo t("Note: When using SMTP make sure the port number is open in your server")?>.<br/>
...
<div class="row">
  <label class="form-label"><?php echo t("Sender")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled New Line")?></label>  
  <?php 
...
<div class="row" style="margin-top:50px;padding-bottom:30px;">
<label class="form-label"></label>
<input type="submit" value="<?php echo Yii::t("default","Save")?>" class="btn btn-sm btn-success">
<a href="javascript:;" class="test-email btn btn-sm btn-outline-primary mt-2"><?php echo t("Click here to send Test Email")?></a>
</div>
