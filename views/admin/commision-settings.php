...
<div class="row">
  <label class="form-label"><?php echo t("Balance include all offline payment")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Enabled Commission")?>?</label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Disabled Membership Signup")?>?</label>
  <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Disabled Membership")?>?</label>
  <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Include Cash Payment on merchant balance")?>?</label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","commission on orders")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Set commission on")?></label>  
</div>
<ul>
...
<div class="row">
  <label class="form-label" style="padding-right:5px;"><?php echo Yii::t("default","Compute Total Commission base on the following order status")?></label>
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","VAT No")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","VAT")?>(%)</label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Account name")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Account number")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Custom Template")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Deposited Timeframe")?></label>
  <?php 
  ...
  ?>
  <span class="text-muted"><?php echo t("after invoice date creation")?></span>
</div>
