...
<div class="row">
  <label class="form-label"><?php echo t("MERCHANT_NEW_SIGNUP")." ".t("EMAIL")?></label>
  <?php 
  ...
  ?>
  <br/>
  <span class="text-muted uk-text-small">
...
<div class="row">
  <label class="form-label"><?php echo t("MERCHANT_NEW_SIGNUP")." ".t("SMS")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("RECEIPT_SEND_TO_ADMIN")." ".t("EMAIL")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("RECEIPT_SEND_TO_ADMIN")." ".t("SMS")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("BOOKED_NOTIFY_ADMIN")." ".t("EMAIL")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("ORDER_IDLE_TO_ADMIN")." ".t("EMAIL")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("ORDER_REQUEST_CANCEL_TO_ADMIN")." ".t("EMAIL")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("ORDER_REQUEST_CANCEL_TO_ADMIN")." ".t("SMS")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Order Idle minutes")?></label>
  <?php 
  ...
  <br/>
  <span class="text-muted uk-text-small" style="padding-left:200px;">
  <?php echo t("Number of minutes to send notification to admin when the order is idle")?>
  </span>
</div>

<div class="row">
  <label class="form-label"><?php echo t("Disabled New Order Notification")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Disabled New Order Notification Sounds")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Days Before Expiration")?></label>
  <?php 
...
<div class="row mt-2">
  <input type="submit" value="<?php echo Yii::t("default","Save")?>" class="btn btn-sm btn-success mt-2">
</div>
