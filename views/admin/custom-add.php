...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Page Name")?></label>
  <?php 
  echo CHtml::textField('page_name',
  isset($data['page_name'])?$data['page_name']:""
  ,array('class'=>"uk-form-width",'data-validation'=>"required"))
  ?>
</div>

<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Icon")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Content")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Open in new window")?>?</label>
  <?php 
