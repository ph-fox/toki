...
<div class="row">
  <label class="form-label"><?php echo t("Enabled")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Enabled RTL")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide website logo")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide how it works section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide featured restaurant section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide browse by cuisine section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide subscription section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide connect with us section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide language bar")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Custom footer")?></label>  
  <?php 
 echo CHtml::textArea('theme_custom_footer',getOptionA('theme_custom_footer'),array(
   'class'=>"big-text-area form-control"
 ))
  ?> 
</div>

<div class="row">
  <label class="form-label"><?php echo t("Featured Restaurant Sort")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Browse Page Sort by")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled search by address")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled search by restaurant name")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled search by street name")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled search by cuisine")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled search by food name")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Top menu")?></label>  
<?php 
$menus = array(
...
<div class="row">
  <label class="form-label"><?php echo t("Hide Menu section")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Hide Others section")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Enabled mobile app section")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Google Play Link")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("App Store Link")?></label>  
  <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo t("Windows Phone Link")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Do not collapse all filters")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Enabled Maps")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("List Style")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Do not collapse menu")?>?</label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled opening hours tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled reviews tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled table booking tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled map tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled photos tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled information tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Disabled promo tab")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Enabled Cookie law")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Exit Link")?></label>  
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo t("Enabled Time Picker UI")?></label>  
  <?php 
