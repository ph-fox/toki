...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Disabled SMS on merchant")?>?</label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Use admin SMS credits to send SMS")?>?</label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Sender ID")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Account SID")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","AUTH Token")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Sender")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Key")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Use Unicode")?>?</label>
  <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo Yii::t("default","User")?></label>
  <?php 
...
-->
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","API Key")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","SMS Type")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Priority")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","API username")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","API password")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Account Key")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Auth ID")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Sender Number")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Auth Key")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Route")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Send unicode message")?></label>
  <?php 
...
<div class="row">
  <label class="form-label"><?php echo Yii::t("default","truncated")?></label>
  <?php 
...
<div class="mt-3">
  ...
  <a href="javascript:;" class="btn btn-sm btn-outline-primary"><?php echo t("Test SMS")?></a>
</div>
