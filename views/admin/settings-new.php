...
<ul class="uk-switcher uk-margin uk_tab" id="tab-content" style="padding:15px 10px;">
  ...
  <li class="uk-active">
	...
	<div class="row"> 
	  ...
	  <a href="javascript:;" id="sau_upload_file" 
	   class="btn btn-sm btn-outline-primary" data-progress="sau_progress" data-preview="website_logo_preview" data-field="photo">
	    <?php echo t("Browse")?>
	  </a>
	</div>
	...
	<!--MOBILE LOGO -->
	  <div class="row"> 
	    ...
	    <a href="javascript:;" id="saup_upload_file" 
	     class="btn btn-sm btn-outline-primary" data-progress="saup_progress" data-preview="mobile_logo_preview" data-field="mobilelogo" >
	     <?php echo t("Browse")?>
	    </a>
  ...
  <li >
   ...
   <div class="row">
	...
	<p class="text-small uk-text-muted">
...
<!--	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Use CURL")?>?</label>  
	<?php 
  ...
  <li>
	...
	<p class="text-small uk-text-muted"><?php echo t("Please generate keys for Google reCAPTCHA v3")?></p>
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Customer signup")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Merchant signup")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Customer login")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Merchant login")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Admin login")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Order")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Driver signup")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enable Contact form")?></label>  
	<?php 
  ...
  <li>
	...
	<div class="row">
	  <label class="form-label"><?php echo Yii::t("default","Enabled logo on receipt")?>?</label>  
	  <?php 
...
<!--	<div class="row"> 
	 <label class="form-label"><?php echo Yii::t('default',"Receipt Logo")?></label>
    ...
    <div class="row"> 
	  ...
	  <a href="javascript:;" id="file_upload2" 
	   class="btn btn-sm btn-outline-primary" data-progress="file_upload2_progress" data-preview="file_upload2_preview" data-field="website_receipt_logo">
		<?php echo t("Browse")?>
	  </a>
	</div>
  ...
  <li>
	...
	<!--<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Disabled Popup")?>?</label>  
	<?php 
	...
	<p class="text-muted uk-text-small"><?php echo t("disabled popup instead use a page");?></p>-->
	
	
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enabled Mobile Verification")?></label>  
	<?php 
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enabled Email Verification")?></label>  
	<?php 
  ...
  <li>
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enabled On Merchant Signup")?>?</label>  
	<?php 
  ...
  <div class="form-control url_2" style="background-color:rgb(255,255,255,0.3);">
	...
	<div class="row">
	<label class="form-label"><?php echo Yii::t("default","Enabled On Customer Signup")?>?</label>  
	<?php 
...
<div class="row form-control mt-1 mb-1">
  <label class="form-label"><?php echo Yii::t("default","Allow only those who has actual purchases")?></label>  
  <?php 
...
<div class="row form-control mt-1 mb-1">
  <label class="form-label"><?php echo Yii::t("default","Disabled Merchant can edit review or delete")?></label>  
  <?php 
...
<div class="row form-control mt-1 mb-1">
  <label class="form-label"><?php echo Yii::t("default","Admin Do Not Allow User Multiple Sigin")?>?</label>  
  <?php 
...
<div class="row form-control mt-1 mb-1">
  <label class="form-label"><?php echo Yii::t("default","Merchant Do Not Allow User Multiple Sigin")?>?</label>  
  <?php 
...
<p class="text-muted uk-text-small"><?php echo t("Note: must be a valid php date format")?>
...
<p class="text-muted uk-text-small"><?php echo t("Note: must be a valid php time format")?>
<br/><a target="_blank" href="http://php.net/manual/en/function.date.php">http://php.net/manual/en/function.date.php</a>
</p>

<div class="form-control mt-1 mb-1 p-3">
  <div class="row ">
  ...
  <div class="row">
    ...
    echo CHtml::textField('website_time_picker_interval',getOptionA('website_time_picker_interval'),array(
      'class'=>"numeric_only p-1 border rounded",
      'style'=>"outline:none!important",
...
<div class="row form-control mt-1 mb-1">
  ...
  ?>
  <p class="text-muted indent"><?php echo t("during checkout customer will need to select their address from the map for delivery location accuracy")?></p>  
</div>
  ...
  <li>
	...
	<div class="row"> 
	  ...
	  <a href="javascript:;" id="file_upload" 
	   class="btn btn-sm btn-outline-primary" data-progress="file_upload_progress" data-preview="file_upload_preview" data-field="photo2">
	    <?php echo t("Browse")?>
	  </a>
	</div>
...
<div class="row form-control mt-1 mb-1">
  ...
  <p><?php echo t("Cancelation of order will only be applied on the following condition")?></p>
   ...
   <!--<div class="row">
	<label class="form-label"><?php echo t("Request Cancel Order decline status")?></label>  
	 <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Disabled Sticky Cart")?></label>  
  <?php 
...
<!--<div class="row">
  <label class="form-label"><?php echo Yii::t("default","Enabled Map Address")?></label>  
  <?php 
